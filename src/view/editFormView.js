        ...
        <header class="event__header">
            <div class="event__type-wrapper">
                <label class="event__type  event__type-btn" for="event-type-toggle-1">
                    ...
                    <img class="event__type-icon" width="17" height="17" src="img/icons/${routePoint.type.toLowerCase() ?? 'taxi'}.png"
                         alt="Event type icon">
                </label>
            ...
            <div class="event__field-group  event__field-group--time">
                ...
                <input class="event__input  event__input--time" id="event-start-time-1" type="text"
                       name="event-start-time" value="${routePoint.timeFrom.toLocaleString([], {
    day: 'numeric', month: 'short', year: 'numeric', hour: '2-digit', minute: '2-digit'
  })}">
                &mdash;
                <label class="visually-hidden" for="event-end-time-1">To</label>
                <input class="event__input  event__input--time" id="event-end-time-1" type="text" name="event-end-time"
                       value="${routePoint.timeTo.toLocaleString([], {
    day: 'numeric', month: 'short', year: 'numeric', hour: '2-digit', minute: '2-digit'
  })}">
            </div>
        ...
        <section class="event__details">
            ...
            <section class="event__section  event__section--destination">
                ...
                <p class="event__destination-description">${routePoint.destination.description}</p>
                ${routePoint.destination.pictures.length > 0 ? `
                  <div class="event__photos-container">
                      <div class="event__photos-tape">
                          ${routePoint.destination.pictures.map((image, index) => `
                          <img class="event__photo" src="${image}" alt="Event photo ${index + 1}">
                        `).join('')}
                      </div>
                  </div>
                ` : ''}
